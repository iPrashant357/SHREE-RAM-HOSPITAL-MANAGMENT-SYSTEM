...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            // Fallback: if DB is unavailable, allow default admin login to proceed
            if ("prashant".equals(un) && "KKKISHAN".equals(p)) {
                new welcome().setVisible(true);
                this.setVisible(false);
            } else {
                JOptionPane.showMessageDialog(null, "Database connection failed. Verify MySQL is running and credentials are correct.");
            }
        }
